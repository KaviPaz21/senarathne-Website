      ...
      <div className="form">
        <div className="inputtiing w-cw500 px-5 py-5 border-2 border-gray-600 rounded-2xl">
          ...
          <form action="" className='mt-5'>
            ...
            <input type="text" placeholder='Enter Your Name' className='px-5 py-2 w-full border border-gray-300 rounded-xl mb-5 mt-2' />

            <label htmlFor="name" className='py-1 text-xl font-semibold text-gray-600'>E-mail*</label><br />
            <input type="email" placeholder='Enter Your mail address' className='px-5 py-2 w-full border border-gray-300 rounded-xl mb-5 mt-2' />

            <label htmlFor="name" className='py-1 text-xl font-semibold text-gray-600'>Subject*</label><br />
            <input type="text" placeholder='Topic you going to discuss' className='px-5 py-2 w-full border border-gray-300 rounded-xl mb-5 mt-2' />

            <label htmlFor="name" className='py-1 text-xl font-semibold text-gray-600'>Messege*</label><br />
            <textarea name="msg" placeholder='Enter Your Messege Here...' className='px-5 py-2 w-full border border-gray-300 rounded-xl mb-5 mt-2 h-24'></textarea>

            <button className='mt-0 bg-blue-600 py-2 px-6 text-white rounded-lg hover:scale-105 duration-200'>Submit</button>
          </form>
        </div>
      </div>
    </div>
